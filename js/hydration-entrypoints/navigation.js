...
`;var It,v=class extends ${constructor(){super(...arguments),this.headline="",this.supportingText="",this.multiLineSupportingText=!1,this.trailingSupportingText="",this.disabled=!1,this.itemTabIndex=-1,this.active=!1,this.isListItem=!0,this.listItemRole="listitem",this.focusOnActivation=!0,this.isFirstUpdate=!0}willUpdate(t){t.has("active")&&!this.disabled&&(this.active?this.itemTabIndex=0:this.isFirstUpdate||(this.itemTabIndex=-1))}render(){return this.renderListItem(c`
    ...
    `}renderRipple(){return c`<md-ripple for="item" ?disabled=${this.disabled}></md-ripple>`}renderFocusRing(){return c`<md-focus-ring class="focus-ring" for="item" inward></md-focus-ring>`}getRenderClasses(){return{"with-one-line":this.supportingText==="","with-two-line":this.supportingText!==""&&!this.multiLineSupportingText,"with-three-line":this.supportingText!==""&&this.multiLineSupportingText,disabled:this.disabled}}renderStart(){return c`<div class="start"><slot name="start"></slot></div>`}renderBody(){let t=this.supportingText!==""?this.renderSupportingText():"";return c`<div class="body"
      ...
      >${this.trailingSupportingText}</span>`}updated(t){super.updated(t),t.has("active")&&!this.isFirstUpdate&&this.active&&this.focusOnActivation&&this.focus(),this.isFirstUpdate=!1}focus(){this.listItemRoot?.focus?.()}};It=v;ct(It);d([p()],v.prototype,"headline",void 0);d([p()],v.prototype,"supportingText",void 0);d([p({type:Boolean})],v.prototype,"multiLineSupportingText",void 0);d([p()],v.prototype,"trailingSupportingText",void 0);d([p({type:Boolean})],v.prototype,"disabled",void 0);d([p({type:Number})],v.prototype,"itemTabIndex",void 0);d([p({type:Boolean,reflect:!0})],v.prototype,"active",void 0);d([p({type:Boolean,attribute:"md-list-item",reflect:!0})],v.prototype,"isListItem",void 0);d([D(".list-item")],v.prototype,"listItemRoot",void 0);var E=class extends v{renderListItem(t){return c`
      <a
        id="item"
        tabindex=${this.disabled?-1:this.itemTabIndex}
        role=${this.listItemRole}
