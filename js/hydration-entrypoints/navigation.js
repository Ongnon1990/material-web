        ...
        <div class="body  ${f.value?"open":""}">
          <div class="spacer" ?inert=${F.value}>
            ${i?c`<div
                  ...
                  ${R({properties:["opacity"],keyframeOptions:{duration:r,easing:"linear"},in:ot,out:et})}
                ></div>`:m}
            <aside
              ?inert=${this.isCollapsible&&!f.value}
              ${R({properties:["transform"],keyframeOptions:{duration:o,easing:a}})}
            >
              <slot
...
</svg>`;var w=class extends G($){constructor(){super(...arguments);this.menuOpen=!1}render(){return c`
      <header>
...
`;var It,h=class extends ${constructor(){super(...arguments),this.headline="",this.supportingText="",this.multiLineSupportingText=!1,this.trailingSupportingText="",this.disabled=!1,this.itemTabIndex=-1,this.active=!1,this.type="listitem",this.isListItem=!0,this.focusOnActivation=!0,this.isFirstUpdate=!0}willUpdate(t){t.has("active")&&!this.disabled&&(this.active?this.itemTabIndex=0:this.isFirstUpdate||(this.itemTabIndex=-1))}render(){return this.renderListItem(c`
    ...
    `)}renderListItem(t){return c`
      <li
        ...
        role=${this.type==="none"?m:this.type}
    ...
    `}renderRipple(){return c`<md-ripple for="item" ?disabled=${this.disabled}></md-ripple>`}renderFocusRing(){return c`<md-focus-ring class="focus-ring" for="item" inward></md-focus-ring>`}getRenderClasses(){return{"with-one-line":this.supportingText==="","with-two-line":this.supportingText!==""&&!this.multiLineSupportingText,"with-three-line":this.supportingText!==""&&this.multiLineSupportingText,disabled:this.disabled}}renderStart(){return c`<div class="start"><slot name="start"></slot></div>`}renderBody(){let t=this.supportingText!==""?this.renderSupportingText():"";return c`<div class="body"
      ...
      >${this.trailingSupportingText}</span>`}updated(t){super.updated(t),t.has("active")&&!this.isFirstUpdate&&this.active&&this.focusOnActivation&&this.focus(),this.isFirstUpdate=!1}focus(){this.listItemRoot?.focus?.()}};It=h;ct(It);d([p()],h.prototype,"headline",void 0);d([p()],h.prototype,"supportingText",void 0);d([p({type:Boolean})],h.prototype,"multiLineSupportingText",void 0);d([p()],h.prototype,"trailingSupportingText",void 0);d([p({type:Boolean})],h.prototype,"disabled",void 0);d([p({type:Number})],h.prototype,"itemTabIndex",void 0);d([p({type:Boolean,reflect:!0})],h.prototype,"active",void 0);d([p()],h.prototype,"type",void 0);d([p({type:Boolean,attribute:"md-list-item",reflect:!0})],h.prototype,"isListItem",void 0);d([D(".list-item")],h.prototype,"listItemRoot",void 0);var E=class extends h{constructor(){super(...arguments),this.type="none"}renderListItem(t){return c`
      <a
        id="item"
        tabindex=${this.disabled?-1:this.itemTabIndex}
        role=${this.type==="none"?m:this.type}
